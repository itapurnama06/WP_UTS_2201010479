...
if(isset($_POST['txNAMA'])) {
    ...
    if($pass1 == $pass2){
        ...
        $sql = "INSERT INTO tbmahasiswa (nim,nama,alamat,tanggal_lahir,jenis_kelamin,email,no_tlp,tempat_lahir,passkey,iduser) VALUES ('$nim','$nama','$alamat','$tgl','$jns','$email','$tlp','$lahir','".md5($pass1)."','".md5($nama)."')";
        ...
        if($hasil){
            ...
            $psn = "Tambah User Gagal,Silahkan diulang";
        }
                ...
                <form method="post" action="">
                    <div>
                        <label class="form-label"><b>NIM</b></label>
                            <input class="form-control" required  type="text" name="txNIM">
                    </div>

                    <div>
                        <label class="form-label"><b>Nama</b></label>
                            <input class="form-control" required  type="text" name="txNAMA">
                    </div>

                    <div>
                        <label class="form-label"><b>Alamat</b></label>
                            <input class="form-control" required  type="text" name="txALAMAT">
                    </div>  

                    <div>
                        <label class="form-label"><b>Tanggal Lahir</b></label>
                            <input class="form-control" required  type="DATE" name="txTGL">
                    </div>
                    ...
                    <div>
                        <label class="form-label"><b>Email</b></label>
                            <input class="form-control" required  type="email" name="txEMAIL">
                    </div>

                    <div>
                        <label class="form-label"><b>Nomor Telephone</b></label>
                            <input class="form-control" required  type="number" name="txTELP">
                    </div>

                    <div>
                        <label class="form-label"><b>Tempat Lahir</b></label>
                            <input class="form-control" required  type="text" name="txLAHIR">
                    </div>
