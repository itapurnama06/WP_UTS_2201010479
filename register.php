        ...
        <div class="col-12 d-flex justify-content-center" style="margin-top:5%">
                <form class="border border-warning p-3 bg-light " method="post" action="">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input class="form-control" required  type="text" name="txNAMA" placeholder="Nama">
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><b>Email</b></label>
                        <input class="form-control" required  type="email" name="txEMAIL" placeholder="Email">
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><b>Username</b></label>
                        <input class="form-control" required  type="text" name="txUSER" placeholder="Username">
                    </div>
